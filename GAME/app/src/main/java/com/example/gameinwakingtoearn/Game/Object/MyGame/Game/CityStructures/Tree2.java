...
public class Tree2 extends CityStructure{
    public static final String name="tree2";
    public static final int id = R.drawable.tree_2;
    public static final double cost= 10 ;
    public static int height = 70;
    public static int width = 70;
    public Tree2(float x, float y, Context context, ArrayList<Structure> mycity, ArrayList<Structure> myDirt,
    ...
    public ItemInBag changeToItemInBag() {
        return new ItemTree2InBag(this.getPosX(),this.getPosY(),this.getContext(),this.getMycity(),this.getMyDirt());
    }
}
